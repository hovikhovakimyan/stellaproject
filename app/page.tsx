          ...
          <div className="mb-12 grid gap-4 text-left sm:grid-cols-2">
            ...
            <div className="rounded-lg border border-pink-100 bg-white p-6 shadow-sm">
              <div className="mb-2 flex items-center gap-2">
                ...
                <h3 className="font-semibold text-gray-900">Flashcard Generation</h3>
              </div>
              <p className="text-sm text-gray-600">
                Create custom flashcards from any topic to help memorize key concepts
              </p>
            </div>
            ...
            <div className="rounded-lg border border-amber-100 bg-white p-6 shadow-sm">
              ...
              <p className="text-sm text-gray-600">
                Get instant access to learning materials, videos, and articles on any subject
              </p>
            </div>
          </div>
